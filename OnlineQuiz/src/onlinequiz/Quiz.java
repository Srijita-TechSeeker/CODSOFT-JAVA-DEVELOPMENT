...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        Image scaledImage = i1.getImage().getScaledInstance(1200, 700, Image.SCALE_SMOOTH);
        ImageIcon i2 = new ImageIcon(scaledImage);
        JLabel image = new JLabel(i2);
        image.setBounds(0, 0, 1200, 365);
        add(image);
        ...
        opt1.setBounds(170, 500, 300, 30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt1);
        
        opt2 = new JRadioButton();
        opt2.setBounds(170, 540, 300, 30);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt2);
        
        opt3 = new JRadioButton();
        opt3.setBounds(170, 580, 300, 30);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt3);
        
        opt4 = new JRadioButton();
        opt4.setBounds(170, 620, 300, 30);
        ...
        lifeline.setBounds(800, 560, 180, 40);
        ...
        submit.setBounds(800, 610, 180, 40);
